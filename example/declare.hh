...
const int Typeid_BindPriv_cons_0 = __COUNTER__;
const int Typeid_Bind_cons = __COUNTER__ ;
const int Typeid_Bind_ec = __COUNTER__ ;
const int Typeid_Bind_error = __COUNTER__ ;
const int Typeid_Bind_facc = __COUNTER__ ;
const int Typeid_Bind_head = __COUNTER__ ;
...
const int Typeid_Bind_mlist = __COUNTER__ ;
const int Typeid_Bind_mnil = __COUNTER__ ;
...
const int Typeid_Bind_tail = __COUNTER__ ;

struct BindPriv_add_0;
struct Bind_add;
struct Bind_bnot;
struct Bind_booly;
struct BindPriv_cons_0;
struct Bind_cons;
struct Bind_ec;
struct Bind_error;
struct Bind_facc;
